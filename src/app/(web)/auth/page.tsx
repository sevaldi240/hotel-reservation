    ...
    <section className="container mx-auto">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8 w-80 md:w-[70%] mx-auto ">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                ...
                <input type="text" name="name"  placeholder="Juana de Armas" required className={inputStyles} value={formData.name} onChange={handleInputChange}/>
                ...
                <button type="submit" className="w-full bg-tertiary-dark focus:outline-none font-medium rounded-lg text-sm px-2.5 text-center">
                    Sing Up
                    </button>
            </form>
